...
<div class="card">
    <div class="card-header">
      <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#exampleModal">Agregar Categoria</button>
              ...
              <table class="display table table-striped table-bordered" id="tablaEquipos">
               ...
               <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- Botón Editar -->
                            <a href="{{ route('categoriashow', $categoria->id) }}" class="btn btn-warning btn-sm">Editar</a>
                            
                            <!-- Botón Eliminar -->
                            <button class="btn btn-danger btn-sm" onclick="confirmDelete({{ $categoria->id }})">Eliminar</button>
                        </td>
                    </tr>
                  @endforeach  
                </tbody> 
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="{{route('categoriaStore')}}" method="POST" enctype="multipart/form-data">
              @csrf
                <div class="mb-3">
  ...
  <script>
    function confirmDelete(id) {
        ...
        function deleteRecord(id) {
            $.ajax({
                url: '/categoria/' + id,  // Ruta para eliminar
                type: 'GET',
                data: {
